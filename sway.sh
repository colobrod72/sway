...
sudo pacman -S sway swayidle swaylock swaybg waybar wofi wmenu terminology geany autotiling grim slurp wl-clipboard cliphist brightnessctl playerctl wlr-randr wdisplays kanshi xdg-desktop-portal-wlr swappy wtype thunar thunar-archive-plugin pavucontrol pamixer network-manager-applet nwg-look eog ttf-jetbrains-mono-nerd gawk polkit bleachbit rofi
